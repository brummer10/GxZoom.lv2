...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    gx_ZoomUI* ui = (gx_ZoomUI*)malloc(sizeof(gx_ZoomUI));
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_ZOOM_PAINT_BOX(ui->pbox),"pedal_expose");
